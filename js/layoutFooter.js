...
<footer class="h-[203px] mt-[72px]">
        <div class="container mx-auto">
            ...
            <div class="flex justify-center gap-x-20 ">
                <div class="flex gap-2 -translate-y-10">
                    <img src="/images/images/footer/symbol.svg" alt="">
                    <p class="text-black-100 text-lg font-semibold leading-6">Доска объявлений</p>
                </div>
                <div class="flex gap-2 -translate-y-10">
                    <img src="/images/images/footer/symbol.svg" alt="">
                    <p class="text-black-100 text-lg font-semibold leading-6">Условия пользования</p>
                </div>
                <div class="flex gap-2 -translate-y-10">
                    <img src="/images/images/footer/symbol.svg" alt="">
                    <p class="text-black-100 text-lg font-semibold leading-6">+998 88 500 50 00</p>
                </div>
            </div>

            <div class="bg-white border-t border-stone-300 w-full px-4 flex justify-between items-center py-4">
                <div class="flex">
                    <span>© 77.uz</span>
